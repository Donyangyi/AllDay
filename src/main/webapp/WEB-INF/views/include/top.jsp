...
<div class="top-bar-body body-font">
	<div class="top-container top-fixed-section">
		...
		<div class="main-logo-section">
			<a class="brand-logo" href="${root}main">
				<img src="${root}image/Allday_Logo_02.png" style="margin-top: 5px;"/>
			</a>
		</div>
		
		<!-- menu-bar-section start -->
		<div class="menu-bar-section">
				<ul class="menu-item-list" style="margin: auto;">
					<div class="menu-item-wrapped">
						<div class="menu-item">
							<li class=""><a class="" href="${root}product/product_main">상품</a></li>
						</div>
						<div class="menu-item">
							<li class=""><a class="" href="${root}cart/cart_board">장바구니</a></li>
						</div>
						<div class="menu-item">
							<li class=""><a class="" href="${root}board/board_main">게시판</a></li>
						</div>
						<div class="menu-item">
							<li class=""><a class="" href="${root}maps/maps_main">지점위치</a></li>
						</div>
					</div>
				</ul>
			</div>
			...
			<div class="myname-section">
	            <div>${loginUserBean.checkStore}</div>
	        </div>		
			<!-- 로그인 드롭다운바 -->
			<div class="login-wrapped" >
				<a class="login-text" style="color: white;">Account</a>
						...
						<c:otherwise>
							...
							<c:choose>
								<c:when test="${loginUserBean.storeName != null}">
									<li class="login-dropdown-item"><a href="${root}owner/owner_main">점주 페이지</a></li>
								</c:when>
							</c:choose>
						</c:otherwise>
					</c:choose>
